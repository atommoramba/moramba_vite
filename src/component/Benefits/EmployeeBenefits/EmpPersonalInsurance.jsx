...
function EmpPersonalInsurance() {
  ...
  console.log(EmpSelectedBenefitList);
  //variable
  const [EmpPersonalData, setEmpPersonalData] = useState([]);

  useEffect(() => {
    if (EmpSelectedBenefitList?.length === 0) {
...
export default EmpPersonalInsurance;
