...
import "./CreateExpenseTemplate.css";
import Cookie from "js-cookie";

function CreateExpenseTemplate() {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  let data = useLocation();
  const updateExpensedata = data.state != null ? data.state.data : "";
  const title = data.state != null ? data.state.title : "";
  ...
  const [text_expense_expTemp, setText_expense_expTemp] = useState(
    ...
    axios
      ...
      .then(function (response) {
        ...
        var g = res.data?.filter(function (j) {
          return j.templatename === "expense_template";
        });
  ...
  const handleAdd = () => {
    if (expenseValidation()) {
      ...
      const d = {
        ...
        // breakuplist: popupData.filter(function (o) {
        //   return o.active;
        // }),
  ...
  useEffect(() => {
    if (updateExpensedata !== "") {
      ...
      var list = updateExpensedata.breakuplist;
      list.map((v, i) => {
        if (popupData.length !== 0) {
          return;
        }
      ...
      setTemplate(updateExpensedata.templatename);
      var EffectiveDateEdit = updateExpensedata.effectiveDate;
  ...
  const SetLanguageText = () => {
    ...
    setText_expense_expTemp(
      doc.querySelector("string[name='text_expense_expTemp']")?.textContent
    );
    setText_DataType(
    ...
    <>
      ...
      >
        ...
        <div className="row p-2">
          ...
          <div className="col-md-4 create-exp-temp-date-div">
            <h4>
              {salaryBreakupTypeEffectiveDateHead}
              <span className="Star">*</span> :
            </h4>
                    ...
                    <li>
                      <>
                        {/* <input
                          ...
                          value="dynamic_name"
                          className="me-2"
                          onChange={(e) => changeDataUser(value, e, org)}
                        /> */}
        ...
        <div className="row">
          <center>
            <Link to="/managetemplate" state={{ data: 0 }}>
      ...
      {popup ? (
        <div className="main">
          <div className="popup create-exp-popup">
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <h5>{text_DataType} :</h5>
                <select
                  className="CountryInputbox1 create-exp-popup-select"
              ...
              <hr />
              <div className="row">
                <center className="create-exp-popup-btns">
...
export default CreateExpenseTemplate;
